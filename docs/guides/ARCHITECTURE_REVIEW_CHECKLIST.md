...
- 修改发布链时，同时同步 `README.md`、`docs/guides/DOCKER_DEPLOYMENT.md`、`docs/INDEX.md`、`deploy/README.md`、`memory/long-term/procedural/deploy-and-release.md`。
- 修改目录职责或边界时，同步 `memory/long-term/semantic/repo-shape-and-agents.md` 与相关架构文档。
