          ...
          >
            ...
            {isAuthenticated && (
              <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
                {/* 房间数量徽章 */}
                <div className="w-full sm:w-auto px-4 py-2 bg-white border-2 border-black shadow-[2px_2px_0_0_#000]">
                  <span className="font-black text-brand-primary text-sm uppercase">
                    {bindings.length} 个房间
                  </span>
                </div>
